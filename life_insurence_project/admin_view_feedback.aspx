<%@ Page Title="" Language="C#" MasterPageFile="~/master1.Master" AutoEventWireup="true" CodeBehind="admin_view_feedback.aspx.cs" Inherits="life_insurence_project.WebForm8" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <p>
<asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Cascadia Code SemiBold" Font-Size="X-Large" ForeColor="#003366" Text="View Feedback"></asp:Label>
</p>
