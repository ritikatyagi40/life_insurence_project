<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agentvisit.aspx.cs" Inherits="life_insurence_project.agentvisit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>agent visit</title>
...
<body>
   ...
   color: white;
   box-shadow: 2px 2px grey; height: 50px;" PostBackUrl="~/feedback.aspx" />
                 <br />
   ...
   box-shadow: 2px 2px grey; height: 50px;" OnClick="Button7_Click" PostBackUrl="~/main_page.aspx" />
              ...
              <div class="col-md-9"  style="background-color:white;height:500px; width:84%">
                ...
                <div style="height: 665px; margin-left: 40px;">
                    ...
                    <br />
                    <br />
                    <asp:Label ID="Label2" runat="server" Text="Your Address" Font-Bold="True" Font-Names="Calibri" Font-Size="X-Large" ForeColor="#003366"></asp:Label>
                    <br />
                    ...
                    <asp:Label ID="Label3" runat="server" Text="Enter Mobile" Font-Bold="True" Font-Names="Calibri" Font-Size="X-Large" ForeColor="#003366"></asp:Label>
                    <br />
                  
                     <asp:TextBox ID="TextBox4" runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="40px" Width="1029px" Style="border-radius: 10px"></asp:TextBox>
                    <br />
                    <br />
                   
                    <asp:Label ID="Label4" runat="server" Text="Enter Email" Font-Bold="True" Font-Names="Calibri" Font-Size="X-Large" ForeColor="#003366"></asp:Label>
                    <br />
                   
                    <asp:TextBox ID="TextBox3" runat="server" Height="40px" TextMode="MultiLine" Width="1029px" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Style="border-radius: 10px"></asp:TextBox>
                    <br />
                    <br />
                     <asp:Label ID="Label5" runat="server" Text="Select Product" Font-Bold="True" Font-Names="Calibri" Font-Size="X-Large" ForeColor="#003366"></asp:Label>
                    <br />
                    ...
                    <asp:Button ID="Button9" runat="server" Height="48px" Text="Submit" Width="480px" BackColor="#00CC00" BorderStyle="None" Font-Bold="True" Font-Names="Calibri" Font-Size="X-Large" OnClick="Button9_Click" style="border-radius: 10px;" />&nbsp;&nbsp;&nbsp;
                    ...
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" ForeColor="#FF6666" Visible="False">Request Submitted</asp:HyperLink>
