<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_profile.aspx.cs" Inherits="life_insurence_project.WebForm1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row" style="width: 100%; height: 500px;">
            <div class="col-md-3" style="background-color: white; width: 16%">
                <p style="font-size: 30px; color: #1c1c9d; font-weight: 700; margin-left: 20px;">
                    USER PANEL
                </p>
                <br />
                ...
                <br />
                <asp:Button ID="Button6" runat="server" Text="Human Policy Calculator" Width="237px" Style="background-color: #3F51B5; color: white; box-shadow: 2px 2px grey; height: 50px;"
            ...
            <div class="col-md-9" style="background-color: white; height: 500px; width: 84%">
               ...
               <div class="row" style="width:100%;height:10px;"></div>
                <div style="border: 1px solid #C0C0C0; height: 1244px; padding: 30px; border-radius: 10px; background-color: #FFFFFF;">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:Label ID="Label1" runat="server" BackColor="White" Font-Bold="True" Font-Names="Candara" Font-Size="XX-Large" ForeColor="#1c1c9d" Text="Update User Details"></asp:Label>
                    <br />
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox1" runat="server" Width="459px" Height="28px" ReadOnly="True"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;
                    <asp:Label ID="Label15" runat="server" Text="DOB : "></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox10" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    &nbsp;
                    <br />
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    &nbsp;
                    <asp:TextBox ID="TextBox18" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label26" runat="server" Text="F Enter Date : "></asp:Label>
                    &nbsp;
                    <asp:TextBox ID="TextBox19" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;<br />
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label27" runat="server" Text="F Exit Date : "></asp:Label>
                    &nbsp;
                    <asp:TextBox ID="TextBox20" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    <br />
                    <br />
                    &nbsp;&nbsp;&nbsp;
                    <br />
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox5" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label11" runat="server" Text="Village : "></asp:Label>
                    &nbsp;<asp:TextBox ID="TextBox6" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox7" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label13" runat="server" Text="State : " Visible="True"></asp:Label>
                    &nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox8" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
                    &nbsp;&nbsp;&nbsp;
                    <br />
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox9" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    <br />
                    <br />
                    <br />
                    <br />
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox14" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    <br />
                    <br />
                    &nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label22" runat="server" Text="Nominee Relation : "></asp:Label>
                    &nbsp;
                    <asp:TextBox ID="TextBox15" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    <br />
                    <br />
                    &nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label23" runat="server" Text="Nominee Age : "></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox16" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    <br />
                    <br />
                    <br />
                    &nbsp;&nbsp;&nbsp;
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox11" runat="server" Width="459px" Height="28px" ReadOnly="True"></asp:TextBox>
                    <br />
                    <br />
                    &nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label18" runat="server" Text="Password : "></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox12" runat="server" Width="459px" Height="28px"></asp:TextBox>
                    &nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                    <br />
                    <br />
                    &nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button8" runat="server" Text="Update Details" Width="224px" Height="38px" BackColor="#0099FF" BorderStyle="None" Font-Bold="True" Font-Names="Calibri" Font-Size="Large" ForeColor="White" Style="border-radius: 10px" OnClick="Button8_Click" />



                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button9" runat="server" Text="Cancel" Width="224px" Height="38px" BackColor="Red" BorderStyle="None" Font-Bold="True" Font-Names="Calibri" Font-Size="Large" ForeColor="White" Style="border-radius: 10px" />
